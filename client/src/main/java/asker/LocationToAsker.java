...
/**
 * Класс, запрашивающий у пользователя данные для создания точки прибытия
 * @author Ivan Kirillov
 */
public final class LocationToAsker extends Asker<Location> {
     ...
     * Конструктор класса
     */
    public LocationToAsker(Console console, InputProvider inputProvider) {
    ...
    public Location builder() {
        console.println("Ввод координат точки прибытия");
